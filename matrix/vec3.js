 ...
 * @returns {vec3} out
 */
/*export*/ function vec3multiply(out, a, b) {
  out[0] = a[0] * b[0];
  out[1] = a[1] * b[1];
  out[2] = a[2] * b[2];
  return out;
 ...
 * @returns {vec3} out
 */
/*export*/ function vec3divide(out, a, b) {
  out[0] = a[0] / b[0];
  out[1] = a[1] / b[1];
  out[2] = a[2] / b[2];
  return out;
 ...
 * @returns {vec3} out
 */
/*export*/ function vec3round(out, a) {
 ...
 * @returns {vec3} out
 */
/*export*/ function vec3scaleAndAdd(out, a, b, scale) {
  out[0] = a[0] + (b[0] * scale);
  out[1] = a[1] + (b[1] * scale);
  out[2] = a[2] + (b[2] * scale);
  return out;
 ...
 */
/*export*/ function vec3squaredDistance(a, b) {
  let x = b[0] - a[0];
  let y = b[1] - a[1];
  let z = b[2] - a[2];
  return x*x + y*y + z*z;
 ...
 */
/*export*/ function vec3squaredLength(a) {
  let x = a[0];
  let y = a[1];
  let z = a[2];
  return x*x + y*y + z*z;
 ...
 * @returns {vec3} out
 */
/*export*/ function vec3inverse(out, a) {
  out[0] = 1.0 / a[0];
  out[1] = 1.0 / a[1];
  out[2] = 1.0 / a[2];
  return out;
 ...
 * @returns {vec3} out
 */
/*export*/ function vec3hermite(out, a, b, c, d, t) {
 ...
 * @returns {vec3} out
 */
/*export*/ function vec3bezier(out, a, b, c, d, t) {
 ...
 * @returns {vec3} out
 */
/*export*/ function vec3random(out, scale) {
  scale = scale || 1.0;
 ...
 * @returns {vec3} out
 */
/*export*/ function vec3transformMat3(out, a, m) {
  let x = a[0], y = a[1], z = a[2];
 ...
 * @returns {vec3} out
 */
/*export*/ function vec3rotateX(out, a, b, c){
  let p = [], r=[];
 ...
 * @returns {vec3} out
 */
/*export*/ function vec3rotateY(out, a, b, c){
  let p = [], r=[];
  //Translate point to the origin
  p[0] = a[0] - b[0];
  p[1] = a[1] - b[1];
 ...
 * @returns {vec3} out
 */
/*export*/ function vec3rotateZ(out, a, b, c){
  let p = [], r=[];
  //Translate point to the origin
  p[0] = a[0] - b[0];
  p[1] = a[1] - b[1];
 ...
 */
/*export*/ function vec3exactEquals(a, b) {
  return a[0] === b[0] && a[1] === b[1] && a[2] === b[2];
}
/**
 ...
 * @function
 */
/*export*/ const vec3forEach = (function() {
  let vec = vec3create();
